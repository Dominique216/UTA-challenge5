...
// this function handels saving the input from each time slot to the local storage
function setBtn(num, obj, timeOfDay, string) {
  saveBtn[num].addEventListener('click', function(){
 obj = {
  timeofDay: timeOfDay, 
...
// this function handles grabbing the changes from the local storage when the page is loaded
